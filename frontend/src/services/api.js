...
const API_GATEWAYS = {
  user: import.meta.env.REACT_APP_USER_SERVICE_URL || 'http://localhost:5001',
  product: import.meta.env.REACT_APP_PRODUCT_SERVICE_URL || 'http://localhost:5002',
  cart: import.meta.env.REACT_APP_CART_SERVICE_URL || 'http://localhost:5003',
  order: import.meta.env.REACT_APP_ORDER_SERVICE_URL || 'http://localhost:5004',
};
